...
import { useCreateVacancy } from '@/hooks/employer/vacancy/useCreateVacancy';
import { createVacancyStyles as styles } from '@/styles/app/employer/vacancy/createVacancyStyles';
